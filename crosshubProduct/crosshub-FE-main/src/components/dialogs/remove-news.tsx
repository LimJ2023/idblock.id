import { deleteMultipleNews } from "@/api/news.api";
...
const RemoveNewsDialog = ({
  ...
  const { mutateAsync } = useMutation({ mutationFn: deleteMultipleNews });
