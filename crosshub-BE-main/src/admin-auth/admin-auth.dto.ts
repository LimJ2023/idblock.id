...
export class AdminSignUpDto extends TypeschemaDto(VSignUpDto) {
  @ApiProperty({
    title: '이메일',
    description: '이메일',
...
export type TAdminLoginDto = v.InferOutput<typeof VLoginDto>;
export class AdminLoginDto extends TypeschemaDto(VLoginDto) {
  @ApiProperty({
    title: '이메일',
    description: '이메일',
    example: 'hello@buttersoft.io',
